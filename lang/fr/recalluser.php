...
$string['mailingtargetactivity'] = 'Activité déclencheuse';
$string['daysafter'] = 'jour(s) après :';
$string['courseenroldate'] = "La date d'inscription au cours";
$string['courselastaccess'] = "La date de dernière connexion au cours";
$string['firstlaunch'] = "La date du premier lancement";
$string['lastlaunch'] = "La date du dernier lancement";
...
$string['mailingbody'] = "Contenu";
$string['sendingtime'] = "Heure d'envoi";
